    ...
    return (
        <div className="container" style={{ maxWidth: '400px', marginTop: '50px' }}>
            <div className="form-container" style={{ padding: '2rem', borderRadius: '12px', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }}>
                <h2 style={{ textAlign: 'center', marginBottom: '1.5rem', color: '#333' }}>會員登記</h2>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="btn btn-primary w-100" style={{ width: '100%', padding: '0.75rem', fontSize: '1rem' }}>登記</button>
                </form>
                <div style={{ marginTop: '1.5rem', textAlign: 'center', fontSize: '0.9rem' }}>
                    已經有帳號？ <Link to="/login" style={{ color: '#6366f1', fontWeight: '500' }}>登入</Link>
                </div>
            </div>
        </div>
    );
